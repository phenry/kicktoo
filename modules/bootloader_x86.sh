...
configure_bootloader_grub2() {
    ...
    debug configure_bootloader_grub2 "GRUB_PRELOAD_MODULES=\"lvm\" to /etc/default/grub"
    echo -e "\nGRUB_PRELOAD_MODULES=\"lvm\"" >> ${chroot_dir}/etc/default/grub
    debug configure_grub2 "generating /boot/grub/grub.cfg"
    spawn_chroot "grub2-mkconfig -o /boot/grub/grub.cfg" || die "Could not generate /boot/grub/grub.cfg"
}
